...
<body class="antialiased">
  <nav class="bg-white border-gray-200 md:px-[160px] px-4">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative max-w-md hidden md:block">
          <form action="" class="relative w-full">
            <input type="search"
              class="peer cursor-pointer relative z-10 h-12 w-0 rounded-full border bg-transparent pl-12 outline-none transition-all duration-500 focus:w-80 focus:cursor-text focus:border-[#39ADF8] focus:pl-16 focus:pr-4" />
        ...
        <button id="profile-button" type="button"
          class="hidden md:inline-flex items-center justify-center w-10 h-10 text-sm rounded-full bg-primary-500 text-gray-100 focus:outline-none focus:ring-2">
    ...
    <div id="navbar-default" class="md:hidden flex items-center justify-between px-4 py-2">
      ...
      <button id="profile-button-mobile" type="button"
        class="inline-flex items-center justify-center w-10 h-10 text-sm rounded-full bg-secondary-500 text-gray-100 hover:bg-secondary-600 focus:outline-none focus:ring-2 focus:ring-secondary-700">
        <span class="sr-only">Open user profile</span>
              ...
              <section class="w-full flex items-center">
                <div class="relative flex items-center w-1/4">
                  ...
                  <select id="category" name="category"
                    class="w-full h-12 pl-8 pr-8 bg-white-100 rounded-l-lg focus:outline-none appearance-none">
                    <option class="text-neutral-800 font-medium" selected>Kategori</option>
                ...
                <input type="text"
                  class="w-3/5 h-12 pl-4 bg-white-100 focus:outline-none border-l border-r font-normal"
                ...
                <button
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-0 md:mr-2" fill="none"
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center">
              ...
              <div class="relative flex items-center">
                <select id="category" name="category"
                  class="bg-white-100 px-3 rounded-l-lg focus:outline-none appearance-none w-full">
  ...
  <footer class="mt-[450px]">
    <div class="relative bg-primary-500 md:bg-transparent">
      <div class="h-full w-full hidden absolute -z-10 md:block">
        <img src="{{ asset('images/RectangleFooter.webp') }}" alt="Footer Background"
          class="h-full w-full object-top">
      </div>

      <div class="relative">
        <img src="{{ asset('images/char6.webp') }}" alt=""
          class="absolute -z-20 hidden md:block left-1/2 transform -translate-x-1/2 md:-translate-y-1/2  w-[450px] md:-top-5  top-1/2">
      </div>

      <ul
        class="px-6 py-20 pb-20 flex flex-wrap gap-11 text-white-100 md:gap-x-20 sm:justify-center md:px-28 lg:justify-between md:pt-64">
        <li class="font-bold">
          <h6>Sosial Media</h6>
          <ul class="font-normal space-y-4 py-4">
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Blog</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Instagram</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Facebook</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Youtube</a>
            </li>
          </ul>
        </li>
        <li class="font-bold">
          ...
          <ul class="font-normal space-y-4 py-4">
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Buku</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Video</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Peringkat</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Lencana</a>
            </li>
          </ul>
        </li>
        <li class="font-bold">
          ...
          <ul class="font-normal space-y-4 py-4">
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Email</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">+62374393823</a>
            </li>
          </ul>
        </li>
        <li class="font-bold">
          ...
          <ul class="font-normal space-y-4 py-4">
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Pernyataan
                Umum</a>
            </li>
            <li class="group">
              <a href="#"
        ...
        <li class="font-bold">
          ...
          <ul class="font-normal space-y-4 py-4">
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Privasi</a>
            </li>
            <li class="group">
              <a href="#"
                class="block transition-all underline-offset-4 duration-500 group-hover:translate-x-4 group-hover:underline">Pernyataan
    ...
    <div
      class="bg-primary-500 text-white-100 px-6 py-10 flex items-center flex-col sm:flex-row sm:justify-between md:px-28">
  ...
  <script>    
    $("#btnHiddenFilter").on("click", function () {
      ...
      if ($filtContainer.hasClass('w-1/4')) {
        ...
        $filtContainer.removeClass('w-1/4').addClass('w-[5%]');        

        $leftArrowIcon.toggleClass("hidden");
        $rightArrowIcon.toggleClass("hidden");
      } else if ($filtContainer.hasClass('w-[5%]')) {
        ...
        $filtContainer.removeClass('w-[5%]').addClass('w-1/4');
      }
    });
  </script>
</body>
