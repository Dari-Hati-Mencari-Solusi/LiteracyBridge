...
<body class="antialiased font-poppins grid place-items-center h-screen">
    <section class="flex flex-col w-full items-center justify-center">
        {{-- row 1 --}}
        <div
            class="w-full md:w-7/12 lg:w-3/12 bg-white min-h-full z-50 bg-white-100 rounded-lg max-md:h-screen max-md:rounded-none">
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <a href="/" class="sm:mx-auto sm:w-full sm:max-w-sm flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="" class="w-[50px] h-[50px] mr-3">
                    <h1 class="text-[18px] text-[#171717] font-semibold ps-4">Literacy Bridge</h1>
                </a>
                <div class="sm:mx-auto sm:w-full sm:max-w-sm space-y-4">
                    <h2 class="mt-10 text-3xl font-semibold leading-9 tracking-tight text-gray-900 text-start">Selamat
                        Datang Bridger!</h2>
                    <p class="text-neutral-600 font-normal font-md">Literacy Bridge meningkatkan literasi membaca
                        melalui buku digital dan sistem reward menarik.</p>
                </div>
                ...
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" action="/signup" method="POST">
                        @csrf
                        <div>
                            <label for="text" class="block text-sm font-semibold leading-6 text-black-5600">Nama
                                Lengkap</label>
                            <div class="mt-2">
                                <input id="text" name="fullname" type="text" value="{{ old('fullname') }}"
                                    autocomplete="off"
                        ...
                        <div>
                            <label for="text"
                                class="block text-sm font-semibold leading-6 text-black-5600">Username</label>
                            <div class="mt-2">
                        ...
                        <div>
                            <label for="email"
                                class="block text-sm font-semibold leading-6 text-black-5600">Email</label>
                            <div class="mt-2">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="password" class="block text-sm font-semibold leading-6 text-black-500">Kata
                                    Sandi</label>
                            </div>
                            <div class="relative">
                                ...
                                <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer"
                                    id="togglePassword">
                                    <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="password_confirmation"
                                    class="block text-sm font-semibold leading-6 text-black-500">Konfirmasi Kata
                                    Sandi</label>
                            </div>
                            <div class="relative">
                                ...
                                <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer"
                                    ...
                                    <svg id="eyeIconConfirmation" xmlns="http://www.w3.org/2000/svg" width="30"
                        ...
                        <div>
                            <button type="submit"
                                class="custom-button flex w-full justify-center rounded-[8px] bg-gradient-to-r from-[#39ADF8] to-[#84CCFA] px-5 py-4 text-sm md:text-lg font-semibold leading-6 text-white shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:bg-gradient-to-l">Daftar</button>
                        </div>
                        <div>

                            <button type="submit"
                                class="custom-button flex w-full justify-center rounded-[8px] bg-black-500 px-5 py-4 text-sm md:text-lg font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:bg-gradient-to-l"><span
                                    class="px-4"> <img src="{{ asset('images/Google svg.png') }}" alt=""
                                        class="w-[22px] h-[22px]"></span>Masuk dengan Google</button>
                        </div>
                    </form>
        ...
        {{-- Backround Image --}}
        <div class="bg-black-400 w-full h-full opacity-50 absolute top-0 left-0 z-20"></div>
        <img src="{{ asset('images/image.png') }}" alt="background image"
