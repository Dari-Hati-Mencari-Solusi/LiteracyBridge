...
<body class="antialiased font-poppins grid place-items-center h-screen"> 
    <section class="flex flex-col w-full items-center justify-center">
        {{-- row 1 --}}
        <div class="w-full md:w-7/12 lg:w-3/12 bg-white min-h-full z-50 bg-white-100 rounded-lg max-md:h-screen max-md:rounded-none">
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" action="/login" method="POST">
                        ...
                        <div>
                            <label for="email"
                                class="block text-sm font-semibold leading-6 text-black-500">Email</label>
                            <div class="mt-2">
                        ...
                        <div>
                            ...
                            <button type="submit"
                                class="custom-button flex w-full justify-center rounded-[8px] bg-black-500 px-5 py-4 text-sm md:text-lg font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:bg-gradient-to-l"><span
                                    class="px-4 object-contain"> <img src="{{ asset('images/Google svg.png') }}" alt=""
                        ...
                        <div class="flex justify-between">
                            <div class="flex items-center gap-x-3 mb-4">
                                ...
                                <label for="default-checkbox" class="ms-[8px] text-sm text-[#8A8A8A]">Ingat untuk 30
                                    hari</label>
                            </div>
