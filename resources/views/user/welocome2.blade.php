  ...
  <section class="my-container py-16 md:py-24">
    <div class="grid md:grid-cols-2 gap-12 items-center">
      <div class="order-2 md:order-1">
        <iframe class="w-full h-[400px] md:h-[500px]" src="https://lottie.host/embed/849e88e5-eea0-44f6-9038-9430c64f5674/Mdks9tSD7W.json"></iframe>
      </div>
      <div class="order-1 md:order-2 text-center md:text-left space-y-8">
        <div class="space-y-4">
          ...
          <p class="text-lg text-gray-600 max-w-lg mx-auto md:mx-0">
            Mulai perjalanan literasi Anda bersama LiteracyBridge. Temukan ribuan buku, tingkatkan pengetahuan, dan raih mimpi Anda.
          </p>
        </div>
        <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
          <button id="btnGo" class="btn-blue rounded-full px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
            🚀 Mulai Sekarang
          </button>
          <a href="{{ route("login") }}" class="btn-blue-outline rounded-full px-8 py-4 text-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
            👤 Masuk Akun
          </a>
        </div>
      </div>
          ...
          <div class="group">
            <a href="{{ "books/" . $book->slug }}" class="block">
              ...
              <div class="mt-4 space-y-2">
                <h6 class="font-semibold text-sm md:text-base line-clamp-2 group-hover:text-primary-600 transition-colors">{{ $book->title }}</h6>
  ...
  <section class="bg-gray-50 py-20">
    <div class="my-container">
      <div class="text-center mb-16">
        ...
        <p class="text-gray-600 text-lg max-w-2xl mx-auto">Platform literasi terdepan dengan fitur-fitur unggulan untuk pengalaman membaca terbaik</p>
      </div>
      ...
      <div class="space-y-20">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6">
            ...
            <p class="text-gray-600 text-lg leading-relaxed">
              Literacy Bridge adalah aplikasi yang menghubungkan Anda dengan buku-buku pilihan untuk membaca, memahami, dan berkembang. Tingkatkan literasi Anda dan raih potensi penuh melalui pengetahuan yang didapatkan.
            </p>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div class="order-1 md:order-2 space-y-6">
            ...
            <p class="text-gray-600 text-lg leading-relaxed">
              Menghadirkan sistem ranking pembaca yang memotivasi Anda untuk membaca lebih banyak. Tingkatkan peringkat Anda dengan setiap buku yang selesai, dan raih penghargaan atas pencapaian literasi Anda.
            </p>
            <div class="space-y-3">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6">
            ...
            <p class="text-gray-600 text-lg leading-relaxed">
              Literasi Baca adalah jembatan menuju mimpi Anda. Dengan membaca, Anda dapat mengakses pengetahuan dan inspirasi yang diperlukan untuk mewujudkan impian dan mencapai kesuksesan.
            </p>
    ...
    <div class="max-w-screen-xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        @foreach ($videos as $video)
          <div class="group">
            <a href="https://www.youtube.com/watch?v={{ $video->youtube_link }}" target="_blank" class="block">
              <div class="relative overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-all duration-300">
              ...
              <div class="mt-4 space-y-2">
                <h6 class="font-semibold text-sm md:text-base line-clamp-2 group-hover:text-primary-600 transition-colors">{{ $video->title }}</h6>
        ...
        <div class="grid grid-cols-4 gap-4 md:gap-8">
          @for ($i = 1; $i <= 8; $i++)
            <div class="group flex flex-col items-center">
              <div class="relative transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
              ...
              <div class="mt-3 text-center">
                ...
                <div class="text-xs text-gray-500">
                  @if($i <= 2) Master Reader
                  @elseif($i <= 4) Expert Reader  
                  @elseif($i <= 6) Advanced Reader
