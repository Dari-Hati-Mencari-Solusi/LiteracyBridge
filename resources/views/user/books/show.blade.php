        ...
        <div>
          <div class="relative w-full mx-auto bg-white">
            <title1 id="textContent1" class="text-black-400 transition-all duration-500 ease-in-out overflow-hidden">
              <span class="block">Setelah membaca buku ini, saya benar-benar merasa tercerahkan. Penulis berhasil
                menggabungkan teori dan praktik dengan cara yang sangat menarik, membuat saya semakin sadar akan
              ...
              <span id="moreText1" class="hidden transition-opacity duration-500 ease-in-out opacity-0">
                Buku ini juga menekankan pentingnya peran keluarga dan lingkungan dalam membudayakan membaca. Dengan
                panduan ini, membaca menjadi bagian tak terpisahkan dari kehidupan sehari-hari, membawa dampak positif
                          ...
                          <div class="relative w-full mx-auto bg-white">
                            <title1 id="textContent2"
                              ...
                              <span class="block">Setelah membaca buku ini, saya benar-benar merasa tercerahkan. Penulis
                                berhasil menggabungkan teori dan praktik dengan cara yang sangat menarik, membuat saya
                                semakin sadar akan pentingnya literasi membaca dalam kehidupan sehari-hari..</span>
                              <span id="moreText2" class="hidden transition-opacity duration-500 ease-in-out opacity-0">
                                ...
                                membaca. Dengan panduan ini, membaca menjadi bagian tak terpisahkan dari kehidupan
                                sehari-hari, membawa dampak positif yang berkelanjutan. Terima kasih telah membaca buku
                                ini.
                              </span>
                            </title1>
                            <div class="pt-12">
