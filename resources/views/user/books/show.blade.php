...
@endsection
@section('content')
    <section class="grid grid-cols-12 items-start my-container gap-6 mt-16">

        <section class="col-span-9 h-fit space-y-6">
            {{-- book overview --}}
            <div class="p-4 bg-neutral-100 rounded-lg">
                ...
                <div class="md:flex w-full md:space-x-0 space-x-2">
                    <div class="w-full md:w-1/3">
                        <img src="{{ asset("images/$book->cover_name") }}" alt="gambar buku literasi membaca"
                            class="rounded-2xl w-full md:w-64">
                    </div>
                    ...
                    <div class="md:flex md:w-2/3 md:space-x-4 flex flex-col w-full space-y-8">
                        <div class="flex flex-col space-y-8">
                            <div class=" md:py-0 pt-8 space-y-3">
                                ...
                                <div class="md:flex md:space-x-4 space-y-2 md:space-y-0 flex-col md:flex-row">
                                    <!-- Tambahkan flex-col pada versi mobile -->
                                    <div class="flex items-center space-x-1">
                                        <img src="{{ asset('images/literasi.webp') }}" alt="gambar icon literasi"
                                            class="w-7 h-7">
                                ...
                                <p class="text-black-400 pt-2">Penulis: <span
                                        class="text-primary-800">{{ $book->author }}</span></p>
                            </div>
                                ...
                                <div class="flex flex-col md:flex-row md:space-x-2 space-y-3 md:space-y-0">
                                    ...
                                    <button
                                        ...
                                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                                class="md:w-7 md:h-7 w-5 h-5" viewBox="0 0 512 512">
                                                <path fill="#ffff" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="32"
                ...
                <div class="relative w-full mx-auto bg-white">
                    <title1 id="textContent" class="text-black-400 transition-all duration-500 ease-in-out overflow-hidden">
                        ...
                        <span id="moreText" class="hidden transition-opacity duration-500 ease-in-out opacity-0">
                            Buku ini juga menekankan pentingnya peran keluarga dan lingkungan dalam membudayakan membaca.
                            Dengan
                            panduan
                            ini, membaca menjadi bagian tak terpisahkan dari kehidupan sehari-hari, membawa dampak positif
                            yang
                            berkelanjutan.Terima kasih telah membaca buku ini.
                        </span>
                    </title1>
                    <div class="pt-12">
                        <button data-target="moreText"
                            class="toggle-button absolute bottom-0 right-0 p-1 rounded-md text-white shadow-lg focus:outline-none bg-neutral-500 hover:bg-neutral-600 transition duration-500 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24">
                                <g fill="none" stroke="#129df7" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5">
            ...
            <section class="bg-neutral-100 p-4 rounded-lg">
                            ...
                            <a href="#" class="block overflow-hidden rounded-xl max-w-full">
                                <div class="relative overflow-hidden rounded-xl">
                                    ...
                                    <div
                                        class="absolute top-0 right-0 flex items-center justify-center w-12 h-8 bg-blue-500 text-white text-xs rounded-tr-xl rounded-bl-xl space-x-1">
                                        <span class="text-white-100 text-title1 font-medium">5</span>
                                        <img src="{{ asset('images/point.webp') }}" alt="Point Icon"
                                            class="w-5 h-5 mr-1">
                                    </div>
                                </div>
                                <h6 class="font-normal pt-3">Judul Buku</h6>
        ...
        <section class="col-span-3 h-fit rounded-lg sticky top-28 space-y-6">
            {{-- points got from book --}}
            <div class="p-4 bg-neutral-100 rounded-lg ">
                <h1 class="text-2xl font-bold capitalize">poin yang akan anda dapatkan</h1>
                <div class="flex items-center flex-col space-x-1 my-6">
                    <img src="{{ asset('images/point-fix.webp') }}" alt="gambar point" class="w-24 h-24">
                    <span
                        class="text-title1 text-black-900 px-3 text-xl font-bold">{{ $book->point != 0 ? intVal($book->point) : '0' }}
                        Poin</span>
                </div>
            </div>

			 <div class="p-4 bg-neutral-100 rounded-lg ">
                <h1 class="text-xl font-bold capitalize">Jumlah Pembaca : 1202</h1>
				<h1 class="text-xl font-bold capitalize">Waktu Baca</h1>
				<h1 class="text-xl font-bold capitalize">Rating</h1>
            </div>
        </section>
                ...
                <div class="w-full md:w-9/12 grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="flex items-start mt-2 mb-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <h6 class="block text-title2 text-black-400 font-normal">Ini adalah contoh deskripsi pokoknya
                                apapun
    ...
    {{-- <section class="contaniner px-2 py-16">
        <div class="md:px-[160px] px-6 space-y-8">
            ...
            <div class="space-y-4 border-b-2 py-3">
                    ...
                    <a href=""
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M12 12c2.208 0 4-1.791 4-4s-1.792-4-4-4-4 1.791-4 4 1.792 4 4 4zm0 2c-4.418 0-8 1.791-8 4 0 1.104.896 2 2 2h12c1.104 0 2-.896 2-2 0-2.209-3.582-4-8-4z" />
                        </svg>
                    </a>
                ...
                <div>
                    <div class="relative w-full mx-auto bg-white">
                        <title1 id="textContent1"
                            class="text-black-400 transition-all duration-500 ease-in-out overflow-hidden">
                            <span class="block">Setelah membaca buku ini, saya benar-benar merasa tercerahkan. Penulis
                                berhasil
                                menggabungkan teori dan praktik dengan cara yang sangat menarik, membuat saya semakin sadar
                                akan
                                pentingnya literasi membaca dalam kehidupan sehari-hari..</span>
                            <span id="moreText1" class="hidden transition-opacity duration-500 ease-in-out opacity-0">
                                Buku ini juga menekankan pentingnya peran keluarga dan lingkungan dalam membudayakan
                                membaca. Dengan
                                panduan ini, membaca menjadi bagian tak terpisahkan dari kehidupan sehari-hari, membawa
                                dampak positif
                                yang berkelanjutan. Terima kasih telah membaca buku ini.
                            </span>
                        </title1>
                        <div class="pt-12">
                            <button data-target="moreText1"
                                class="toggle-button absolute bottom-0 right-0 p-1 rounded-md text-white shadow-lg focus:outline-none bg-neutral-500 hover:bg-neutral-600 transition duration-500 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24">
                                    <g fill="none" stroke="#129df7" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5">
                        ...
                        <div class="flex items-center space-x-2">
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                                    ...
                                    <g fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round">
                                        <path
                                            d="M1.046 5.814h2.351v6.26h-2.35a.496.496 0 0 1-.497-.496V6.31a.496.496 0 0 1 .496-.496" />
                                        <path
                                            d="m3.397 5.814l2.52-4.028a1.08 1.08 0 0 1 .933-.516a1.1 1.1 0 0 1 1.14 1.09v2.887h4.356a1.14 1.14 0 0 1 1.091 1.31l-.793 5.119a1.13 1.13 0 0 1-1.121.992H5.014c-.31.001-.615-.07-.892-.208l-.715-.357m-.01-6.289v6.26" />
                                    </g>
                                </svg></a> <span>112</span>
                            <a href="#" class="pl-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" viewBox="0 0 24 24">
                    ...
                    <div class="md:flex items-center group flex">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-8 h-10 rotate-6 transtition-all group-hover:scale-110" viewBox="0 0 16 16">
                            <path fill="#84CCFA"
                        ...
                        <a href="#" id="show-popup"
                            class="text-title2 text-primary-500 px-2 transition-all group-hover:underline group-hover:scale-110">Lihat
                            12 balasan</a>
                    </div>

                    <!-- Popup -->
                    <div id="popup" class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog"
                        aria-modal="true">
                        <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
                        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                <div
                                    class="relative transform overflow-hidden rounded-lg bg-white bg-opacity-100 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                        ...
                                        <div class="mt-4 max-h-80 overflow-y-auto space-y-3">
                                            ...
                                            <div class="space-y-4 border-b-2 py-3 p-3">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <title1 class="text-black-400 font-semibold">KangKomen</title1>
                                                    <img src="{{ asset('images/Rangking.webp') }}" alt=""
                                                        class="w-[22px] h-[24px]">
                                                </div>
                                                <div>
                                                    <div class="relative w-full mx-auto bg-white">
                                                        <title1 id="textContent2"
                                                            class="text-black-400 transition-all duration-500 ease-in-out overflow-hidden">
                                                            <span class="block">Setelah membaca buku ini, saya benar-benar
                                                                merasa tercerahkan. Penulis
                                                                berhasil menggabungkan teori dan praktik dengan cara yang
                                                                sangat menarik, membuat saya
                                                                semakin sadar akan pentingnya literasi membaca dalam
                                                                kehidupan sehari-hari..</span>
                                                            <span id="moreText2"
                                                                class="hidden transition-opacity duration-500 ease-in-out opacity-0">
                                                                Buku ini juga menekankan pentingnya peran keluarga dan
                                                                lingkungan dalam membudayakan
                                                                membaca. Dengan panduan ini, membaca menjadi bagian tak
                                                                terpisahkan dari kehidupan
                                                                sehari-hari, membawa dampak positif yang berkelanjutan.
                                                                Terima kasih telah membaca buku
                                                                ini.
                                                            </span>
                                                        </title1>
                                                        <div class="pt-12">
                                                            <button data-target="moreText2"
                                                                class="toggle-button absolute bottom-0 right-0 p-1 rounded-md text-white shadow-lg focus:outline-none bg-neutral-500 hover:bg-neutral-600 transition duration-500 ease-in-out">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6"
                                                                    viewBox="0 0 24 24">
                                                                    <g fill="none" stroke="#129df7"
                                                    ...
                                                    <div class="md:flex justify-between py-4 flex">
                                                        ...
                                                        <div class="flex items-center space-x-2">
                                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="w-6 h-6" viewBox="0 0 14 14">
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                        <button id="close-popup" type="button"
                                            class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-white-100 bg-gradient-to-r from-[#39ADF8] to-[#84CCFA] sm:mt-0 sm:w-auto hover:from-[#39ADF8] hover:to-[#84CCFA] hover:bg-gradient-to-l ">Close</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="space-y-4 border-b-2 py-3 p-3">
                ...
                <div>
                    ...
                    <div class="md:flex items-center group flex">
                        ...
                        <a href="#" id="show-popup2"
                            class="text-title2 text-primary-500 px-2 transition-all group-hover:underline group-hover:scale-110">Lihat
                            12 balasan</a>
                    </div>

                    <!-- Popup -->
                    <div id="popup2" class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog"
                        aria-modal="true">
                        <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
                        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                                <div
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                        <button id="close-popup2" type="button"
                                            class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-white-100 bg-gradient-to-r from-[#39ADF8] to-[#84CCFA] sm:mt-0 sm:w-auto hover:from-[#39ADF8] hover:to-[#84CCFA] hover:bg-gradient-to-l ">Close</button>
                                    </div>
                                </div>
                            </div>
