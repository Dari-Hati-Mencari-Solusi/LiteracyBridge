      ...
      <div class="flex justify-center">
        ...
        <div class="w-full flex flex-col items-center justify-center">
          <div class="w-full max-w-3xl bg-white-100 p-3 rounded-3xl shadow-lg">
            <form action="{{$keywords }}" method="GET" class="w-full flex items-center">
              ...
              <input type="text" value="{{ $keywords }}" class="w-3/5 h-12 pl-4 bg-white-100 border-neutral-400 focus:outline-none focus:border-y-0 focus:ring-0 border-y-0 border-l border-r font-normal" placeholder="Cari buku berdasarkan..">
      ...
      <div class="md:flex gap-8 justify-between">
        <div class="flex items-end">
          <h5 class="text-neutral-800">
            ...
            <b class="font-semibold text-black-500">{{ $keywords ?? "Semua buku" }}</b>
          </h5>
        </div>
        <div class="space-y-2">
