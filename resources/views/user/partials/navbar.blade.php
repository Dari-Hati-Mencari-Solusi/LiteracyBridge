<nav class="sticky top-0 z-20 bg-white-100 border-gray-200 ">
  <div class="max-w-full flex items-center justify-between max-md:p-4 md:py-[22px] my-container">
    ...
    <div class="flex items-center">
      <a href="{{ route("home") }}" class="flex items-center ">
		...
		<p class="ml-2 font-bold text-2xl">Literacy Bridge</p>
      </a>
    </div>

	    <!-- Navigasi Desktop -->
      <ul  class="hidden lg:flex font-medium space-x-8 rtl:space-x-reverse ml-6">
    ...
    <div class="items-center space-x-4 hidden lg:flex">
      ...
      @auth()
        <div id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
          class="w-12 h-12 bg-slate-200 rounded-md transition-all cursor-pointer hover:scale-110">
      ...
      @else
        <a 
          href="{{ route("login") }}"
          class="btn-blue !duration-300 custom-button hidden md:flex text-center rounded-md px-[22px] py-2 text-lg font-semibold leading-6">
          Masuk
        </a>    
      @endauth
    </div>
    ...
    <button id="menu-toggle" type="button"
      class="ml-auto inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg lg:hidden text-gray-400 hover:bg-primary-100"
  ...
  <!-- Navigasi Mobile -->
  <div id="navbar-default" class="hidden lg:hidden w-full py-4 shadow-sm my-container">
    ...
    <div class="relative flex-grow mt-4 lg:hidden">
    ...
    @guest
      <div class="w-full">
        <a 
          href="{{ route('login') }}"
          class="btn-blue inline-block text-center rounded-md w-full px-[22px] py-2 text-lg font-semibold leading-6 mt-4">
          Masuk
        </a>      
      </div>
    @endguest
